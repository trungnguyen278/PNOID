...
static void MX_SDMMC1_SD_Init(void)
{
  ...
  /* Skip CubeMX HAL_SD_Init — we handle SD init in app.cpp (SDCard::init)
     to avoid Error_Handler() when no SD card is inserted. */
  return;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_D2_Pin|CAM_PWDN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CAM_RESET_GPIO_Port, CAM_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_BLK_Pin|LCD_D_C_Pin|LCD_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, BNO_RST_Pin|SPI4_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_BLK_Pin LCD_D_C_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = LCD_BLK_Pin|LCD_D_C_Pin|LCD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : MUX_S4_Pin MUX_S0_Pin MUX_S1_Pin MUX_S2_Pin
                           MUX_S3_Pin */
  GPIO_InitStruct.Pin = MUX_S4_Pin|MUX_S0_Pin|MUX_S1_Pin|MUX_S2_Pin
                          |MUX_S3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
