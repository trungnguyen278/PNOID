/**
 * @file    lcd_font.h
 * @brief   Simple 8x16 ASCII font for LCD driver
 */
...
/* 8x16 font covering ASCII 32 (' ') to 126 ('~') = 95 characters
 * Each character is 16 bytes (8 pixels wide, 16 rows, 1 bit per pixel)
